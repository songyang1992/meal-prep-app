...
export const RECIPES: Recipe[] = [
  ...
  },
  {
    ...
    name: '白灼虾仁',
    covers: '周四/日晚餐 的主蛋白',
    ingredients: ['虾仁（按清单量）', '姜片 3 片', '料酒 1 勺', '盐少许'],
    steps: [
      '虾仁解冻，挑去虾线，厨房纸吸干水分',
...
export const PREP_SUNDAY: PrepBlock[] = [
  ...
  },
  {
    ...
    tracks: [
      ...
      { lane: '灶台 2（煎锅）', items: ['鸡胸腌 20 分钟', '分批煎/烤鸡胸', '虾仁白灼 90 秒过冰水'] },
...
export const PRICE_DISCLAIMER =
  '所有单价为小象超市/七鲜超市北京参考价（2026 年 9 月口径），仅用于预算估算，实际以下单页为准；单价可直接在清单里修改，总价自动重算。'
